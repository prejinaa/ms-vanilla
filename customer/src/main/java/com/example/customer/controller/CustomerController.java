...
public class CustomerController {
    ...
    private ResponseEntity<List<CustomerResponseWithAccount>> getCustomerByUserID(@PathVariable Long userId) {
        log.info("Received request to fetch customer for user ID: {}", userId);
         List<CustomerResponseWithAccount> customerAccountList=customerService.getCustomerByUserId(userId);
        log.info("Returning {} customer for user ID: {}", customerAccountList.size(), userId);
